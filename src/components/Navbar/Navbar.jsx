  ...
  return <div className="container mx-auto">
    <nav className='flex justify-between items-center m-5 rounded-lg px-4'>
     <Link to='/' className='hidden lg:block'>
        <img src={logo} alt="" />
        <span className='text-primary-700 font-semibold text-sm'>Safarni</span>
     </Link>
     <div className='hidden lg:block'>
        <ul className='flex justify-between items-center gap-6 *:font-semibold *:text-secondary-900 *:hover:text-primary-700 *:transition-colors *:duration-200'>
            <li>
                <NavLink to="home" className={ ({isActive})=>{return isActive? 'text-primary-700': ''}}>Home</NavLink>
            </li>
            <li>
                <NavLink to='favorite' className={({isActive})=>{return isActive? 'text-primary-700': ''}}>Favorite</NavLink>
            </li>
            <li>
                <NavLink to='compare' className={({isActive})=>{return isActive? 'text-primary-700': ''}}>Compare</NavLink>
            </li>
            <li>
                <NavLink to='maps' className={({isActive})=>{return isActive? 'text-primary-700': ''}}>maps</NavLink>
            </li>
        </ul>
     </div>
     <div className='hidden lg:block'>
